...
const int ENEMYROW = 4;
const int ENEMYCOL = 4;
const float ENEMYSTARTX = 100.f;
const float ENEMYSTARTY = 150.f;
const float ENEMYSPACINGX = 100.0f;
const float ENEMYSPACINGY = 50.0f;
const float ENEMY_SPEED = 4000.0f;
